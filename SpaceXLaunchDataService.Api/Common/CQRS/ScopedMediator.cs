...
/// <summary>
/// A scoped mediator that works with scoped service dependencies
/// </summary>
public class ScopedMediator : IMediator
{
    private readonly IServiceProvider _scopedServiceProvider;

    public ScopedMediator(IServiceProvider scopedServiceProvider)
    {
    ...
    public async Task<TResponse> Send<TResponse>(IRequest<TResponse> request, CancellationToken cancellationToken = default)
    {
        ...
        var handler = _scopedServiceProvider.GetService(handlerType);
